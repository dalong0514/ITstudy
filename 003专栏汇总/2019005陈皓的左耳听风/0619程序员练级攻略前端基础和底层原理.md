...
An introduction to Websockets（[An Introduction to WebSockets | Treehouse Blog](https://blog.teamtreehouse.com/an-introduction-to-websockets)），一个 WebSocket 的简单教程。
