...
其实，有时候学习还是蛮有压力的。且不说这一轮恶补机器学习、深度学习的那些，就近日这个学习感慨颇多：

一、几年前可忽略的那些细节，现在必须重新重视。

二、过去三年的技术细节，几乎完全变了，也正因为如此，之前那些变得重要起来。

三、非搞明白不可，因为要用。

技术上搞明白其实也不难，别人都开发出来能搞不明白，但实在是都是不讲人话，难。像某位大神那样的作者太少（这次也把他的经典梳理翻出来了），没他的时候，只能我们充当自己的大神。

同时，虽然对 AI 有信心，但 AI 真到了狭小的专业领域的时候，能力还是相当有限。现在大众对于 AI 的高期待，一个原因是他们只看到大众领域。

专业领域，用的不是 AI 预训练的知识库，而应该是它的能力：理解能力、推理能力、解释能力。

用预训练知识库会相当不理想，外接知识库（RAG）也不理想。

只有靠人机互助才行，同时明显感受到，人为主。

### 200

方军 2023/11/28

canva 很牛，但 canva 真是面临 AI 的巨大挑战

另，它可说很好用，也可以说极其难用。当然，大众产品都难用，比如 notion 真是没法用。

今年 6 月份，Canva 的估值被其投资人做了大幅度的调整，从 400 亿美金调整到了 130 亿美金，下降幅度高达 67%，投资人给出调整的理由是跟已经上市的同类公司进行比较所致。当时 Canva 的 ARR 为 15 亿美金，并且已经连续 6 年实现了盈利。

最新的消息称，Canva 的 ARR 已经突破 20 亿美金了，并且增长率达到了 50%，可能会在 2024 年启动 IPO 上市。与此同时还有 Databricks，尽管其现金流还没有为正，但其 ARR 增长率也高达 50%，接近 20 亿美金，可能会在 2024 或者 2025 年启动 IPO 上市。

### 201

方军 2023/11/28

原来 Stephen Wolfram 的《这就是 GPT》是先有视频，再有文章及出版成书，那喜欢看视频的人可以看这个三小时视频。
...
其实跟他争论的人不是典型的工科出身的人，工科出身的人哪个不是天天撞墙，畅想的是另一类物种。

但另一个角度是，乐观总没错的。之前是奇点大学的那套逻辑，现在好像有新的一套逻辑，叫技术加速。但不管叫什么，其实意思都是乐观。

（我比较不喜欢标签化讨论，这里就是引述他的观点，什么领域都有多种视角，看具体人才较好）

摘：关于人工智能，和一个理科男争论了很长时间。

最后双方打了个赌。他说：五年以内，无司机的自动驾驶车辆，就将在路上到处跑。

我说：五十年五百年也没戏。

众理科男都有一个幻觉：我们正处在技术大爆发的前夜。我只好一遍遍对他们重复：我们正处在技术撞墙的常规时代。
...
这几天没有摘录各种 AI 的技巧过来，因为忙着用「人类智能」去解码一大堆资料，也就是，像大模型训练那样：

搜寻并学习一大堆资料，排除差的，找到好的，加上自己的

然后，稍后这些学到的参数会被用来运行推理，提问 - 回答，也就是实际运用所学到的知识。

间隙也想，如果人工智能能够替代这个必须人类智能做的事情多好，或者至少大幅降低这个过程的难度、时间？

目前看很难，因为中间用到的全是暂时 AI 做不到的：

- 之前的知识积累与线索

- 搜寻超大量的资料，尤其是高质量的资料

- 搜寻没有数字化、甚至还只存在个别人头脑中的资料
...
这不是什么难事，因为不是创新，就是掌握一个知识，然后为运用做准备。

但这每一步都只能让 AI 来协助、加速，但却不能替代：

1）AI 在这类问题上的效果还不佳，这也不难理解，人类最聪明的群体之一在过去几年搞出来的，AI 就那么容易搞明白了？

2） 我们也在用这个过程训练自己的大脑，如果我们不人类智能来做，主要目的达不到。

3）必须同样经过人类的大脑的处理，我们才能有信心相信进一步处理过的资料的正确性。这个判断力，本来就是人的责任。

另外，以我目前的理解，人工智能和人类智能还有一个大的差别。

人工智能可以几百倍、甚至几千倍效率地试验，但是，它不会跳跃到一个截然不同的想法上去。

人类智能的试错速度要低得多，但人类智能天然地有着一种跳跃到一个截然不同想法上去的能力。

比方说，一个问题长期搞不定，然后出门走一圈的过程中，有了一个新的想法。

我有个感想，或许类似这样的任务会一直是人类智能的任务，因为它不需要干很多次，干少数几次就够了，干完了，结果本来就简单可以让人使用。因此，也就没有标准化的可能性。

AI 使用感悟#

题外话，之前觉得「AI 使用感悟」这个系列没多大价值（对我有价值，对别人没多大价值），还是之前那些实用的专栏系列才对我之外的朋友们有价值。

现在想想也不一定，既然我自己会关注推上那些实际干活的人的碎碎念，那其实真干活带来的感悟可能对人是有意义的。

（但不要看那些大师的如纳瓦尔、格雷汉姆，要看真干活的，说话掺杂各种具体事务的，大师的总结太抽象了，阶段性一起看看就行了。）

### 204

方军 2023/11/29

这个技巧太有用了：arxiv.org 论文转为 html 格式

宝玉：分享个阅读 arxiv.org 上论文的技巧，通常它上的论文都是 PDF 格式的，其实对于阅读很不友好，尤其是对于需要翻译对比阅读的。

一个技巧是你把论文摘要页 url 中的域名中的「x」换成「5」，就能用 HTML5 的格式阅读，比如说：

arxiv.org/abs/2305.16291

换成：

ar5iv.org/abs/2305.16291

那么就能看到 HTML 版本的论文。它是官方基于原始的 LaTeX 借助 LaTeXML 再加手工校对而成，几乎原样保持了原始论文的格式，但更适合手机阅读，也可以方便的使用翻译插件。

实际指向这个链接：

ar5iv.labs.arxiv.org/html/2305.16291

但由于需要手工后期整理，所以更新通常要滞后一个月左右，也就是最新的论文你是无法在上面看到。

还有一个替代方案就是使用：

arxiv-vanity.com

它也是借助 LaTeXML 生成，但是没有人工校对，所以格式要乱一些，并且很多论文无法正确转换，但作为一个替代也不错。

（来源 twitter.com/dotey/status/1729602153805701533，经格式整理 )

### 205

方军 2023/11/29

摘：最近在评测多个国产模型，发现有几个模型应该是训练的不对（不点名了）：

1、Prompt 中，中英文混杂会使性能极大下降。比如输出的 json 的字段最好用中文字段。

2、效仿 OpenAI 写 Prompt 的方式用 message 来做 few-shot 不管用。需要把所有 Prompt 堆在第一个 user message 中。

3、在某些数据集上应该是被过训练了。比如选择题我在 Prompt 里强调最后要输出：最终答案是 A。

它非要输出最终选项：A。

固定格式训练过了导致无视了指令。

4、模型不遵守指令，不仅仅是输出格式，包括一些要求等各种无视。

以上都应该是训练数据问题，比如 sft 阶段有少量不遵守指令的错误数据，模型就学会了我可以不遵守指令。

在强化学习阶段如果有类似脏数据，甚至只要几条数据就会导致能力下降。

点评：时间宝贵，所以这是为什么我暂时对真正的评测水平较差的预训练模型或微调没兴趣的原因。至少微调没那么理想。

### 206

方军 2023/11/29

很牛的提示语，将 ChatGPT APP 转变成翻译机：

"从现在开始你是同声传译。当我说中文，你就翻译成英文，当我说英文，你就翻译成英文。你在翻译时不要加入其他任何评论或者引述，仅仅忠实翻译语句即可。当我用中文或者英文说「翻译结束」后，你应当总结整个对话的内容"

启动对话后，在手机 ChatGPT 上打开，就可以语音同传了（其实是交替传译，哈）
...
【维基创始人：GPT 写百科一团糟，超越人类的 AI 还要五十年】当地时间 11 月 27 日，维基百科创始人吉米·威尔士坦言，ChatGPT 在写维基百科文章时「很糟糕」、「完全不能用」，他认为超人类的 AI 可能至少需要五十年才能实现。ChatGPT-4 以一种看似合理的方式写错了很多事实，而且遗漏了很多内容，还编造了一些来源，简直是一团乱麻。
...
摘：所有一线产品经理都应该尽快拥有一个自己的（AI 相关的）「产品」，不管它是什么，App，一个账号，一个持续更新的文档，都可以。

它应该是一个事业，最起码是一个生意，是一个具体的、有实感的事情，不是做 AB 实验看数据 —— 实验做多了，人只会看数据，不是好事。

听一期播客，讲对 AI 的运用。乙方创意公司迅速用 chatGPT 和 midjourney 把方案写了出来，卖给客户；零食制造商不停追问 chatGPT 麦丽素的历史，优缺点，为了制造出改良的当代麦丽素。

这都是有实际落地的应用。

只停留在出图玩一玩、用 AI 写周报，这还是纯消费。又或者对比到底国内哪家 AI 最先进，又陷入了类似「影评人」的身份里。

你需要一个具体的东西，有创造性的工作，用 AI「把活干了」，就不管那么多了。

非互联网行当的人，有一个具体的产品的人，会用 AI 真的是上火箭。

强烈建议你拥有一个自己的产品，届时，工具就是工具，好用的工具。

---

第一段「（AI 相关的）」字样我加的，事后再看，这个人果然讲话透着小红书语气，嘿嘿。嘿嘿这个词就怎么都不会在小红书出现。
...
[专访 Pika Labs 创始人：探索视频生成的 GPT 时刻](https://mp.weixin.qq.com/s/B1ZGrqJTAPF6DvFi9-wXZQ?poc_token=HCcUaGWj_Z9lX5mMn_Pl7d-DYkExnogvWEUDODQO)

点评：我倾向于认为视频生成是个应用问题，而非技术问题。同时，视频生成就如人形机器人一样，是很难的技术性挑战，但直接的实用性很弱。

点评 by 归藏

海外独角兽对 Pika 创始团队做了比较深入的访谈，和福布斯那种不同的是他们问的问题比较专业。同时 Pika 创始团队的两个人也透露了比较多的一些东西，这可能是第一次视频生成领域的前沿团队透露这么多东西。所以一些认知和方向性的东西对想要做这个事情和投资的人来说还是比较重要的。我基于自己最近关于 AI 视频的一些问题和比较关注的信息筛选和整理了一下这个访谈中的关键内容。各位也可以一起看看讨论一下： 视频生成和图像生成的区别是什么？
...
互联网上视频生成的训练数据集相对于图像更少，也给获取高质量数据增加了难度。现在视频生成有哪些关键点需要突破？
...
还需要考虑 general artifact 的问题，比如说一个人有两个头，就是这种明显不符合常理的问题，也是需要避免的。视频生成的技术路线是否收敛？ 

现在还没有收敛，大家都在往各种方向尝试，每个人都认为自己的模型是最好的，可能有人认为 autoregressive 最好，有人认为 Masked Model 最好。Pika 基于 Diffusion Model，但是开发了很多新东西，是一种新的模型。AI 视频什么时候会迎来 GPT 时刻？ 目前视频生成处于类似 GPT-2 的时期，很可能在未来一年内有一个显著的提升。在视频生成领域什么样的数据算高质量的数据？
...
版权也是重要的问题视频生成上开源社区的参与问题？

开源社区可能没有足够的算力来训练新的视频模型，因为训练一个新视频模型需要非常多的机器。

视频模型本身的问题还没得到解决，因此大家可能会遇到一些瓶颈。首先，模型性能可能不够好，其次，一些算法方面的问题也不够好。

视频最终可能需要像训练 GPT 那样的大规模算力，现在大家还没使用那么多算力，一方面是因为视频模型还没达到像 GPT 那样的水平，另一方面是因为还有一些架构和技术上没解决的问题。未来一年最关心的三个问题？
...
国外的生意真是有意思，这个人家随着 AI 开出来的边缘业务，20 万美元一年，六个月时间。
...
摘： HeyGen，由其产品生成的各种跨语言翻译视频一直是最近社交媒体上的热门，昨晚宣布其 ARR 已经突破 1800 万美金，而在今年 3 月份其 ARR 才 100 万美金（花了 7 个月时间），10 月份为 1000 万美金，相当于从 100 万美金到 1800 万美金 ARR 只用了 9 个月时间。

HeyGen 的联合创始人 Joshua Xu 和 Wayne Liang 在接受福布斯采访时说，当我们看视频时主要有两件事：一个是剪辑，另一个是摄像（Camera）。剪辑并不昂贵，因为它是一种标准流程，但摄像非常昂贵，而 HeyGen 正在解决这个问题。

这也就是这次 HeyGen 推出即时头像（Instant Avatar 2.0）功能想解决的问题，让人们更容易创建出现在其视频中的自定义 AI 头像。仅 Avatar 生成这个领域，本身就已经产生了无数个现象级产品，估计这块未来会成为越来越多产品的一个功能。

---

在用 HeyGen，已经贡献了 250 美元。他们这个采访里面有个观点倒是蛮匹配我的感受的：

我以为剪辑很重要。（但我这种人不会自己去剪的了，我哪会，得交给专业人士）。

而生成、多语言生成很重要。的确如此，一招鲜。我们都不想用真人出镜的 avatar，我觉得罐头 avatar 就够用了。

对比而言，我觉得 canva, veed 其实做得更好一些，但就是败在这一招鲜上。他们过去做得越好，现在作为普通用户的我们，就越感受到它们新功能上得慢。

[1 年 1800 万美金 ARR，AI 掘金热里的华人创业者（2）](https://mp.weixin.qq.com/s/hGlywlpUAVsQV2-9l1xyXw)

[AI Video Startup HeyGen Launches Near-Instant Avatar Generator, Adds $5.6 Million In Funding](https://www.forbes.com/sites/kenrickcai/2023/11/29/ai-video-startup-heygen-launches-near-instant-avatar-generator-adds-56-million-in-funding/?sh=f28637b67826)

福布斯今天对 HeyGen 的报道：

- HeyGen 目前拥有 25 名员工。

- 刚刚获得一笔 560 万美元的融资，估值 7500 万美元。

- HeyGen 在今年 3 月实现了 100 万美元的年度循环收入，在 10 月达到 1000 万美元。目前，这一数字已增至 1800 万美元。
...
Xu 在 Snap，而 Liang 曾在 Karaoke 应用创业公司 Smule 和 TikTok 的母公司字节跳动担任产品设计师。

### 212

方军 2023/11/30

刚刚说的国外那家搞 AI 写作培训的，他们的主业似乎是企业代笔、写作培训、商业咨询。他们有个业务叫「品类海盗」（Category Pirates）。

其中，他们提出的内容品类五个层级还是蛮有意思的，我尝试着翻译一下：

Level 1: A Consumer 内容消费

Level 2: A Curator 内容聚合 --> 我摘笔记接近于这类

Level 3: An Obvious Creator 常识内容 --> 我其实比较喜欢这类，没那么多反常识。我写的超入门也都是这类。附件是前段时间搞的，不关心主题的人也可看看形式：）

Level 4: A Non-Obvious Creator 反常识内容 --> 大众可喜欢这类了

Level 5: How To Monetize As A Category Creator 独特品类 --> 创造一个独特品类出来。

放眼望去，有谁？好像很少、极少。

吴晓波的表述是一种品类，刘润的工作方法论是一种品类，小马宋的餐饮品牌定价也算一种吧。—— 他们的自媒体真是写太多，反而我现在不喜欢他们的品类了，吴老师的杭州那本书反而要好看些，刘润还是得到和后来成熟的 5 分钟商学院好，自媒体完全不行，小马宋蛮勤奋的，尤其看他拍视频真勤奋啊，但是就我个人来说，从其他人那里学到更多。

放到 AI 这个领域，不说学术研究这个部分，有独特品类感的吗？好像吴恩达超级大牛的大众 AI 教育算一个，宝玉老师的翻译也算是一个。
...
今天是 GenAI 进入大众市场一年，真是天翻地覆的一年，一年前，一条推宣布 ChatGPT 上线，五天后宣布 100 万用户时马斯克老师还贱兮兮下面问，一个提问成本多少。
